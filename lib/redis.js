...
module.exports = class Redis {
  ...
  static buildConn(redisUrl, maxRetries) {
    ...
    if (redisUrl && redisUrl.match(/^cluster:\/\/.+:[0-9]+$/)) {
      ...
      return new IORedis.Cluster(config, {lazyConnect: true, clusterRetryStrategy: opts.retryStrategy, redisOptions: opts, slotsRefreshInterval: 5 * 60 * 1000, slotsRefreshTimeout: 10000});
    } else {
