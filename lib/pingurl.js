...
exports.httpAgent = new http.Agent({keepAlive: true,  maxSockets: Infinity});
exports.httpsAgent = new https.Agent({keepAlive: true,  maxSockets: Infinity});
exports.destroyAgents = () => {
  exports.httpAgent.destroy();
...
exports.ping = async (pingUrl, inputData, timeout, timeoutWait) => {
  ...
  const opts = {
    ...
    agent: pingUrl.match(/^https/) ? exports.httpsAgent : exports.httpAgent
  };
