 ...
 */
export const updateItemPromise = (params, client) => client.updateItem(params).promise();

export const update = async (id, payload = null, segments = [], extras = null, client = null) => {
  client = client || (await client());
  const params = await updateParams(id, payload, segments, extras);
  const result = await updateItemPromise(params, client);
  return updateResult(id, payload, segments, extras, result);
};
 ...
 */
export const updateParams = async (id, payload, segments, extras) => {
 ...
 */
export const updateResult = async (id, setPayload, setSegments, setExtras, result) => {
  ...
  const newPayload = setPayload || (oldPayload && (await inflate(oldPayload))) || null;
