...
const LegacyAdzerkImpressions = require('../lib/inputs/legacy-adzerk-impressions');

describe('legacy-adzerk-impressions', () => {

  let adzerk = new LegacyAdzerkImpressions();
  ...
  it('pings impression url records', () => {
    ...
    let adzerk2 = new LegacyAdzerkImpressions([
  ...
  it('complains about failed pings', () => {
    ...
    let adzerk3 = new LegacyAdzerkImpressions([
